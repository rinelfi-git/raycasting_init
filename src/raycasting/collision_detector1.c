...
/*   Updated: 2025/05/27 20:07:41 by erijania         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	var->map_y = player->y - (int)roundf(var->dy * (MOVE_STEP + 5));
	var->map_x = player->x - (int)roundf(var->dx * (MOVE_STEP + 5));
}
...
{
	var->map_y = player->y + (int)roundf(var->dx * (MOVE_STEP + 5));
	var->map_x = player->x - (int)roundf(var->dy * (MOVE_STEP + 5));
}
